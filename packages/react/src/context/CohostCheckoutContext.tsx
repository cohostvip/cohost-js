...
import type { CartSession, Customer, PersonAddress, UpdatableCartSession } from '@cohost/node';
...
export const CohostCheckoutProvider: React.FC<CohostCheckoutProviderProps> = ({
    ...
    const preValidate = async (data: unknown): Promise<unknown> => {
        assertCartSession();
    ...
    return (
        <CohostCheckoutContext.Provider value={stateValue}>
            {children}
