 ...
 * cohost's own DOM, e.g. https://cohost.vip/pay/elements) and the partner-side host tag
 * (`<CohostPaymentFrame>`) embedded in the partner's React page.
 *
 ...
 *
 * This is the public partner contract, so it lives in the public lib — the partner host
 * never imports anything from cohost's internal packages.
 */
